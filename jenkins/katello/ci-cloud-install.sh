...
lein runproject org.clojars.blrm/ovirt.client 0.1.4-SNAPSHOT -r $OVIRT_URL -u $OVIRT_USER  -p $OVIRT_PASSWORD -c $OVIRT_CLUSTER -n $INSTANCE_NAME -t $OVIRT_TEMPLATE_NAME -o ovirt-instance-address.txt -m $MB_RAM --sockets $CPUS

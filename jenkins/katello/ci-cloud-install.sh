...
lein runproject ovirt.client LATEST -r $OVIRT_URL -u $OVIRT_USER  -p $OVIRT_PASSWORD -c $OVIRT_CLUSTER -n $INSTANCE_NAME -t $OVIRT_TEMPLATE_NAME -o ovirt-instance-address.txt -m $MB_RAM --sockets $CPUS
